...
@SuppressLint("NewApi")
public class PulseRateDetail extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chart_pulse_rate_detail_layout);
		tvPulse = (TextView)findViewById(R.id.tv_valuePulseRate);
        ...
        mTimer = new Runnable() {
            ...
            public void run() {
                graph2LastXValue += 1d;
                mSeries1.appendData(new DataPoint(graph2LastXValue, _pulseGraph), true, 60);
                tvPulse.setText(pulseValue);
