...
@SuppressLint("NewApi")
public class AmbientTemperatureDetail extends Activity{

	TextView title;
	TextView tvambient;
	
	private static String ambientValue;
	private static double _ambientGraph;
	...
	public AmbientTemperatureDetail() {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chart_ambient_detail_layout);
		tvambient = (TextView)findViewById(R.id.tv_ambientValue);
		
		getActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
		getActionBar().setCustomView(R.layout.actionbar);
		title = (TextView) findViewById(getResources().getIdentifier("action_bar_title", "id", getPackageName()));
		title.setText("Ambient temperature");
        ...
        mSeries1.setColor(new Color().parseColor("#2E7D32"));
        ...
        mTimer = new Runnable() {
            ...
            public void run() {
                graph2LastXValue += 1d;
                mSeries1.appendData(new DataPoint(graph2LastXValue, _ambientGraph), true, 60);
                tvambient.setText(ambientValue);
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 1) {
					...
					if (begin == 0 && end == 19) {
						...
						_ambientGraph = Double.parseDouble(ambientValue);
