package com.example.bluetoothexample.circularprogressbar;
...
public class CircleProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            circleLabel = typedArray.getString(R.styleable.CircleProgressBar_circleLabel);
            labelColor = typedArray.getInteger(R.styleable.CircleProgressBar_labelColor, 0);
        } finally {
            typedArray.recycle();
        }

        backgroundPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        backgroundPaint.setColor(adjustAlpha(Color.GRAY, 0.3f));//
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(circleLabel+"", 300.f, 350.f, circlePaint);
    }
    ...
    public void setLabelCircle(String label){
    	circleLabel = label;
    	invalidate();
    	requestLayout();
    }
    public String getLabelCircle(){
    	return circleLabel;
    }
}