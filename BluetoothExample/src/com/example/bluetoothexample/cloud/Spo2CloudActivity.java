...
public class Spo2CloudActivity extends Activity{

	private ListView listPulse;
	private ArrayList<HashMap<String, String>> arrayListPulse;
	private ResponseServer response;
	private static final String OBJECT1 = "spo2";
	private static final String OBJECT2 = "ngay";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText("Nồng độ oxy máu- thống kê");
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						response.getArrayList(_json, arrayListPulse, OBJECT1, OBJECT2);
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							ListAdapter adapter = new SimpleAdapter(getApplicationContext(), arrayListPulse,
									R.layout.single_spo2_cloud, new String[] { OBJECT1, OBJECT2 },
									new int[] { R.id.tv_value_spo2_cloud, R.id.tv_value_date_spo2_cloud });
							listPulse.setAdapter(adapter);

							mSeries = new LineGraphSeries<>(getDataPointServer());
							mSeries.setColor(Color.CYAN);
	...
	private DataPoint[] getDataPointServer(){
