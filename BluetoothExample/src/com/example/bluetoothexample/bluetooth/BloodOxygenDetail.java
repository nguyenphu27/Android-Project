...
@SuppressLint("NewApi")
public class BloodOxygenDetail extends Activity{

	TextView title;
	TextView tvSpo2;
	
	private static String oxygenValue;
	private static double _oxygenGraph;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chart_spo2_detail_layout);
		tvSpo2 = (TextView)findViewById(R.id.tv_value_spo2);
		
		getActionBar().setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM);
		getActionBar().setCustomView(R.layout.actionbar);
		title = (TextView) findViewById(getResources().getIdentifier("action_bar_title", "id", getPackageName()));
		title.setText("Pulse Oximeter");
        ...
        mSeries1.setColor(new Color().parseColor("#00695C"));
        ...
        mTimer = new Runnable() {
            ...
            public void run() {
                graph2LastXValue += 1d;
                mSeries1.appendData(new DataPoint(graph2LastXValue, _oxygenGraph), true, 60);
                tvSpo2.setText(oxygenValue + " %");
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 1) {
					...
					if (begin == 0 && end == 19) {
						...
						_oxygenGraph = Double.parseDouble(oxygenValue);
