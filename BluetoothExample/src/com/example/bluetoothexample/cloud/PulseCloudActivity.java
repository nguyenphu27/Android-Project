...
public class PulseCloudActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText("Nhịp tim - thống kê");
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							ListAdapter adapter = new SimpleAdapter(getApplicationContext(), arrayListPulse,
									R.layout.single_pulse_cloud, new String[] { OBJECT1, OBJECT2 },
									new int[] { R.id.tv_value_pulse_cloud, R.id.tv_value_date_cloud });
